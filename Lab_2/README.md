...
* Ομοίως και το **cacheline size**, το οποίο όπως αναφέρθηκε και σε διάλεξη φέτος, αυξάνει την πολυπλοκότητα, απαιτώντας παραπάνω πύλες και συνδέσεις με L2cache και RAM.
* Το **CPI** , πολλαπλασιάζεται στο τέλος, καθώς θέλουμε να είναι αντιστρόφως ανάλογο του κόστους, που αποτελεί τον πρώτο όρο της συνάρτησης Eval(συνάρτηση κόστους)


### Αποτελέσματα αναζήτησης της βέλτιστης υλποίησης.

| Benchmarks | L1 Data size kB | L1 Data Assoc | L1 Instruction Size kB | L1 Istruction Assoc| L2 Size kB | L2 Assoc | Cacheline Size | CPI | Eval |
| --- | --- | --- | --- | --- | --- | ---| --- | --- | --- |
| 401.bzip2 | 128 | 2 | 16 | 2 | 4096 | 16 | 256 | 1.563040 | _159656.34_ |
| **401.bzip2 (PPC)** | 64 | 2 | 16 | 2 |	1024 | 2 | 64 | 1.634346 | **17533.17** |
| 429.mcf | 64 | 4 | 64 | 2 |	4096 |  8 | 512 | 1.064488 | _33743.69_ |
| **429.mcf (PPC)** | 16 | 2 | 32 | 2 |	1024 | 2 | 32 | 1.126211 | **8301.91** |
| 456.hmmer | 128 | 8 | 128 | 8 |	1024 |  2 | 512 | 1.177334 | _63816.62_ |
| **456.hmmer (PPC)** | 32 | 2 | 16 | 2 |	1024 | 2 | 32 | 1.195885 | **8815.51** |
| 458.sjeng | 128 | 4 | 128 | 2 |	4096 | 8 | 2048 | 2.636396 | _320728.33_ |
| **458.sjeng (PPC)** | 16 | 2 | 16 | 2 | 1024 | 2 | 512 | 3.071029 | **36413.81** |
| 470.lbm | 16 | 2 | 16 | 2 |	4096 |  4 | 2048 | 1.374752 | _90611.81_ |
| **470.lbm (PPC)** | 16 | 2 | 16 | 2 |	1024 | 2 | 512 | 1.492126 | **17692.44** |
